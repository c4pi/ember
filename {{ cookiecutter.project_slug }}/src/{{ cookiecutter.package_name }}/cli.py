"""CLI entrypoint for {{ cookiecutter.project_name }}."""
...
click_config.HEADER_TEXT = "[bold cyan]{{ cookiecutter.package_name }}[/] - [dim]{{ cookiecutter.description }}[/]"
...
@click.group(cls=OrderPreservingGroup, help="{{ cookiecutter.description }}")
